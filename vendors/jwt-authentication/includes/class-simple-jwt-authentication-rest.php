...
class Simple_Jwt_Authentication_Rest {
	...
	/**
	 * Generate a JWT from activation
	 *
	 * @param object $request a WP REST request object
	 * @since 1.0
	 * @return mixed Either a WP_Error or current user data.
	 */
	public function generate_token_after_activation( $activation ) {
...
function generate_token_after_activation( $activation ) {
	$jwt_init = new Simple_Jwt_Authentication_Rest( 'auth', '1.4.0' );

	return $jwt_init->generate_token_after_activation( $activation );
}
